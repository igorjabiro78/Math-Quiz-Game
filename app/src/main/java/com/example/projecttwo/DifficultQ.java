...
public class DifficultQ extends AppCompatActivity {
    ...
    private String date,level="difficult";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_difficult_q);

        btn_start = findViewById(R.id.btn_startD);
        btn_answer0= findViewById(R.id.btn_answer0D);
        btn_answer1 = findViewById(R.id.btn_answer1D);
        btn_answer2= findViewById(R.id.btn_answer2D);
        btn_answer3 = findViewById(R.id.btn_answer3D);
        tv_score = findViewById(R.id.tv_scoreD);
        tv_timer= findViewById(R.id.tv_timerD);
        tv_questions = findViewById(R.id.tv_questionsD);
        tv_bottommessage =  findViewById(R.id.tv_bottommessageD);

        tv_timer.setText("0 Sec");
        tv_questions.setText("Calculate : ");
        tv_bottommessage.setText("Press Difficult To Start");
        ...
        View.OnClickListener answerButtonListener= new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(g.getTotalQuestions()<=10){
                    ...
                    //timer.onFinish();
                    tv_bottommessage.setText("Difficult Level Completed: " + g.getNumberCorrect() + "/" +(g.getTotalQuestions() - 1));
                    timer.cancel();
                    tv_timer.setText("0");
                    addData();
                }
    ...
    public void viewScores(View view) {
        viewscore = findViewById(R.id.Vscore);
    ...
    public void chooselevel(View view) {
      levels = findViewById(R.id.Clevel);
